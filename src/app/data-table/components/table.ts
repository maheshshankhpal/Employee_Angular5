...
export class DataTable implements DataTableParams, OnInit {
    ...
    @Input() NoSearchCss = false;
    @Input() filterByState: boolean = false;
    @Input() filterByTags: boolean = false;
    @Input() StateDropDownOptionData: any;
    @Input() TagListDropDownOptionData: any;
    ...
    @Output() cellClick1 = new EventEmitter();
    @Output() OnSearchList = new EventEmitter();
    ...
    // functions:
    @Output() OnAddBtnClickEvent = new EventEmitter();
    @Output() OnDataExportToExcelEvent = new EventEmitter();
    ...
    public setStateName(value) {
        ...
        if (value != null) {
            this.OnStateChange.emit(this.StateDropDownOptionData.find(x => x.value === value).label);
        } else {
            this.search();
            this.OnStateChange.emit(null)
        }
    }
    public FilterChangeTags(value) {
        this.searchText = "";
        this.OnSearchList.emit();
